	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="tab-content">
			...
			<?php else : ?>
				...
				<p>Faça <a href="#test-popup" class="open-popup-link">download do questionário</a> a ser preenchido pela administração pública e conheça quais são as perguntas desse diagnóstico que tem por objetivo entender como os municípios vêm se preparando para elaborar ou revisar seus Planos de Educação.</p>
					...
					<tr>
						...
						<td>
							<div class="bar-container">
								...
								<div class="progress">
								  <div class="bar bar_complano" style="width: <?php echo intval($resultados['qs_01']['Sim']/$total*100)?>%;"></div>
								</div>
