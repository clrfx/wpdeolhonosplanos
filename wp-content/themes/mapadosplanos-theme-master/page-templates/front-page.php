...
<li><a href="#">Guia de Participa&ccedil;&atilde;o na Constru&ccedil;&atilde;o e Revis&atilde;o de Planos de Educa&ccedil;&atilde;o</a></li>
<li><a href="#">Guia de Participa&ccedil;&atilde;o de Crian&ccedil;as e Adolescentes</a></li>
<li><a href="#">O Uso dos Indiques na Constru&ccedil;&atilde;o de Planos de Educa&ccedil;&atilde;o</a></li>
<li><a href="#">Indicadores da Qualidade na Educa&ccedil;&atilde;o</a></li>
</ul>

</div>

<div id="title-querys">
<div class="triangulo"></div><h1 class="noticias"><a href="<?php echo esc_url( home_url( '/category/noticias/' ) ); ?>">Noticias</a></h1>
...
<div id="query-posts" class="noticias">
	...
	?>
		<div id="cada-post" <?php post_class(); ?>>
			...
			</div>						<a href="<?php the_permalink(); ?>" rel="bookmark" class="leia-mais"><span class="mais">+</span>			</a>
